        ...
        <div className="pointer-events-none relative z-10">
          <Reveal>
            <h1 className="pointer-events-auto text-4xl sm:text-6xl font-black text-zinc-100 md:text-8xl">
              Hi, I'm Amrit<span className="text-indigo-500">.</span>
            </h1>
          </Reveal>
          <Reveal>
          ...
          <Reveal>
            <p className="pointer-events-auto leading-relaxed md:leading-relaxed max-w-xl text-sm text-zinc-300 md:text-base">
              I've spent the last 4 years crafting engaging web experiences and
              building frontend solutions. I'm passionate about creating
              intuitive user interfaces and bringing designs to life. Let's
              connect!
            </p>
          </Reveal>
          <Reveal>
